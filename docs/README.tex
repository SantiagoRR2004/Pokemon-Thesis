...
\section{Referencias}
Se deberán citar todas las fuentes de información empleadas para la realización del trabajo. Se deberá emplear un estilo uniforme para todas ellas y se aportará, en cada caso:
\begin{itemize}
    \item Autor/a/es/as.
    \item Título del artículo, libro, monografía,...
    \item Editorial o nombre de la revista.
    \item Número de la revista, volumen y páginas (solo para revistas).
    \item Año de publicación.
    \item Dirección y fecha de consulta (solo para URL).
\end{itemize}

Se recomienda emplear para las referencias de artículos, revistas y otras fuentes de referencia el formato APA, ISO 690, IEEE o similares, y mantenerlo uniforme a lo largo de toda la sección.

\begin{thebibliography}{1}
    \bibitem{pokemonShowdown}
    Pok\'emon Showdown,
    \textit{Pok\'emon Showdown Battle Simulator}.
    \newblock Disponible en: \url{https://play.pokemonshowdown.com/}
    \newblock (consulta: 13 de mayo de 2026).
\end{thebibliography}

...
\begin{itemize}
    \item \textbf{Hipótesis \HOne}: se intentó conprobar si la incorporación de características de la representación del estado de la batalla mejoraría los resultados del aprendizaje. La hipótesis queda parcialmente rechazada porque el número de parámetros en global y el hiperparámetro \emph{pokemon} no muestran una relación clara con el rendimiento del modelo. Sin embargo, en los hiperparámetros \emph{player} y \emph{opponent} sí se observa una relación clara entre el número de parámetros y el rendimiento del modelo, lo que indica que la hipótesis no se puede rechazar en su totalidad.

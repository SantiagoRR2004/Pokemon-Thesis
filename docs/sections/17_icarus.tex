\section{\lang{Daedalus and Icarus}{Dédalo e Ícaro}}

\ifthenelse{\equal{\LANG}{es}}{
    Traducción al español del libro VIII de \textit{Metamorfosis} de Ovidio\cite{metamorfosis}:
}{}
\ifthenelse{\equal{\LANG}{en}}{
    Spanish translation of Book VIII of Ovid's \textit{Metamorphoses}\cite{metamorfosis}:
}{}

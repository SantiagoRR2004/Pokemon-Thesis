...
\begin{table}[h]
    ...
    \begin{tabular}{llcr}
        ...
        actor                                         & Arquitectura de la red neuronal del actor.                 & \ref{anexo:hyperActor}   & 4                 \\
        critic                                        & Arquitectura de la red neuronal del crítico (o si se usa). & \ref{anexo:hyperCritic}  & 5                 \\
